 ...
 */
template<LedId Id> struct LedTraits;
...
template<> struct LedTraits<LedId::ID> { \
  ...
  inline static constexpr csl::PinConfig configuration{csl::pin::Id::PIN, csl::pin::Mode::MODE, csl::pin::Pull::PULL, csl::pin::Speed::SPEED}; \
