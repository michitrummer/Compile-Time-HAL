...
/** @brief Applies aggregated GPIO initialization for the compile-time BSL
 * mappings. */
struct BoardConfig {
  ...
  static void applyMultiEx() {
    typedef LedTraits<LedId::ld4> L0;
    typedef SwitchTraits<SwitchId::b1> S0;
    typedef LedTraits<LedId::ex1> L1;
    typedef SwitchTraits<SwitchId::ex1> S1;
    typedef LedTraits<LedId::ex2> L2;
    typedef SwitchTraits<SwitchId::ex2> S2;
    typedef LedTraits<LedId::ex3> L3;
    typedef SwitchTraits<SwitchId::ex3> S3;
    typedef LedTraits<LedId::ex4> L4;
    typedef SwitchTraits<SwitchId::ex4> S4;
    typedef LedTraits<LedId::ex5> L5;
    typedef SwitchTraits<SwitchId::ex5> S5;
    typedef LedTraits<LedId::ex6> L6;
    typedef SwitchTraits<SwitchId::ex6> S6;
    typedef LedTraits<LedId::ex7> L7;
    typedef SwitchTraits<SwitchId::ex7> S7;
    typedef LedTraits<LedId::ex8> L8;
    typedef SwitchTraits<SwitchId::ex8> S8;
    ...
    csl::PortConfiguration<csl::port::a, S1, S2, S3, S4>::apply();
    csl::PortConfiguration<csl::port::b, L1, L2, L3, L4, L5, L6, L0>::apply();
    csl::PortConfiguration<csl::port::c, S5, S6, S0>::apply();
    csl::PortConfiguration<csl::port::d, S7>::apply();
    csl::PortConfiguration<csl::port::e, L7, S8>::apply();
