...
class RCC {
 public:
  ...
  static void periEnable(PeriId id) { enableMask(static_cast<uint32_t>(id)); }
 ...
 private:
  ...
  static Regs& registers() {
    return *reinterpret_cast<Regs*>(static_cast<uint32_t>(basePeriphAHB1) +
                                    base);
  }
