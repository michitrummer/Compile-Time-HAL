...
int main(void){ bsl::BoardConfig::apply();
  bsl::Led<bsl::LedId::ld4> led0; bsl::Switch<bsl::SwitchId::b1> sw0;
  bsl::Led<bsl::LedId::ld4> led1; bsl::Switch<bsl::SwitchId::b1> sw1;
  bsl::Led<bsl::LedId::ld4> led2; bsl::Switch<bsl::SwitchId::b1> sw2;
  bsl::Led<bsl::LedId::ld4> led3; bsl::Switch<bsl::SwitchId::b1> sw3;
  bsl::Led<bsl::LedId::ld4> led4; bsl::Switch<bsl::SwitchId::b1> sw4;
  bsl::Led<bsl::LedId::ld4> led5; bsl::Switch<bsl::SwitchId::b1> sw5;
  bsl::Led<bsl::LedId::ld4> led6; bsl::Switch<bsl::SwitchId::b1> sw6;
  bsl::Led<bsl::LedId::ld4> led7; bsl::Switch<bsl::SwitchId::b1> sw7;
  bsl::Led<bsl::LedId::ld4> led8; bsl::Switch<bsl::SwitchId::b1> sw8;
