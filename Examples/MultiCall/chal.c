/**
 * @file chal.c
 * @brief MultiExCall benchmark application for the chal implementation.
 *
...
int main(void){ bsl_boardConfigureGpioMultiEx();
  bsl_Led led0; bsl_Switch sw0; bsl_ledBind(&led0,bsl_led4); bsl_switchBind(&sw0,bsl_switchB1);
  bsl_Led led1; bsl_Switch sw1; bsl_ledBind(&led1,bsl_ledEx1); bsl_switchBind(&sw1,bsl_switchEx1);
  bsl_Led led2; bsl_Switch sw2; bsl_ledBind(&led2,bsl_ledEx2); bsl_switchBind(&sw2,bsl_switchEx2);
  bsl_Led led3; bsl_Switch sw3; bsl_ledBind(&led3,bsl_ledEx3); bsl_switchBind(&sw3,bsl_switchEx3);
  bsl_Led led4; bsl_Switch sw4; bsl_ledBind(&led4,bsl_ledEx4); bsl_switchBind(&sw4,bsl_switchEx4);
  bsl_Led led5; bsl_Switch sw5; bsl_ledBind(&led5,bsl_ledEx5); bsl_switchBind(&sw5,bsl_switchEx5);
  bsl_Led led6; bsl_Switch sw6; bsl_ledBind(&led6,bsl_ledEx6); bsl_switchBind(&sw6,bsl_switchEx6);
  bsl_Led led7; bsl_Switch sw7; bsl_ledBind(&led7,bsl_ledEx7); bsl_switchBind(&sw7,bsl_switchEx7);
  bsl_Led led8; bsl_Switch sw8; bsl_ledBind(&led8,bsl_ledEx8); bsl_switchBind(&sw8,bsl_switchEx8);
