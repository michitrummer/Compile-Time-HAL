...
static inline uint16_t bsl_switchPin(bsl_Switch id){ static const uint16_t pins[]={GPIO_PIN_13,GPIO_PIN_0,GPIO_PIN_1,GPIO_PIN_2,GPIO_PIN_3,GPIO_PIN_4,GPIO_PIN_5,GPIO_PIN_6,GPIO_PIN_7}; return pins[(unsigned)id]; }
static inline int bsl_switchPressed(bsl_Switch id){ return HAL_GPIO_ReadPin(bsl_switchPort(id),bsl_switchPin(id))==GPIO_PIN_SET; }
#endif
