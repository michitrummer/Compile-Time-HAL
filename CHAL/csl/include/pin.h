...
{
  csl_pin0 = 0,
  csl_pin1, csl_pin2, csl_pin3, csl_pin4, csl_pin5, csl_pin6, csl_pin7,
  csl_pin8, csl_pin9, csl_pin10, csl_pin11, csl_pin12, csl_pin13,
  csl_pin14, csl_pin15
} csl_PinId;
 ...
 * @pre @p pin must point to writable storage.
 * @note The aggregated benchmark path uses csl_pinBind() and csl_portConfigure()
 *       instead, so several pins can share one update per GPIO register.
 */
