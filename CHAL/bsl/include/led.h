...
static inline void bsl_ledBind(bsl_Led* led, bsl_LedId id) {
  switch (id) {
    case bsl_led4:
      csl_pinBind(&led->pin, csl_portB, csl_pin13);
      break;
    case bsl_ledEx1:
      csl_pinBind(&led->pin, csl_portB, csl_pin0);
      break;
    case bsl_ledEx2:
      csl_pinBind(&led->pin, csl_portB, csl_pin1);
      break;
    case bsl_ledEx3:
      csl_pinBind(&led->pin, csl_portB, csl_pin2);
      break;
    case bsl_ledEx4:
      csl_pinBind(&led->pin, csl_portB, csl_pin3);
      break;
    case bsl_ledEx5:
      csl_pinBind(&led->pin, csl_portB, csl_pin4);
      break;
    case bsl_ledEx6:
      csl_pinBind(&led->pin, csl_portB, csl_pin5);
      break;
    case bsl_ledEx7:
      csl_pinBind(&led->pin, csl_portE, csl_pin6);
      break;
    case bsl_ledEx8:
      csl_pinBind(&led->pin, csl_portH, csl_pin0);
      break;
  }
}
...
static inline void bsl_ledOn(bsl_Led* led) { csl_pinSet(&led->pin); }
